...
public class ValueCompareExample {
	public static void main(String[] args) {
		...
		System.out.println("equals() 후 == 결과 : " + (obj1.equals(obj2))); // true
		...
		System.out.println("언박싱 후 == 결과 : " + (obj3.intValue() == obj4.intValue())); // false
		System.out.println("equals() 후 == 결과 : " + (obj3.equals(obj4))); // true
